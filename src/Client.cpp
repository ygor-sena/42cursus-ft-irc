...
/*   Updated: 2024/05/30 21:25:55 by caalbert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
 * This function sets the password for the client. The password is used for authentication
 * purposes when connecting to a server.
 *
 ...
 *
 * This function sets the authentication status of the client to the specified value.
 *
 ...
 *
 * This function sets the operator status of the client. An operator is a user with special privileges
 * and permissions in the IRC server.
 *
 * @param is_operator A boolean value indicating whether the client is an operator or not.
 */
 ...
 *
 * This function returns the buffer of the client, which contains the received data.
 *
 ...
 *
 * This function returns the hostname of the client by concatenating the nickname and IP address.
 *
 ...
 *
 * This function adds the specified channel to the list of channels that the client has been invited to.
 *
 ...
 *
 * This function constructs a response message using the sender's hostname, target, and message.
 * It then sends the response message to the client's file descriptor using the send() function.
 * If the send() function fails, an error message is printed to the standard error stream.
 *
